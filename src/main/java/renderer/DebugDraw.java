...
//    6 float per vertex, 3 for position and 3 for color, 2 vertices per line
...
//    =========================================================================
    ...
    public static void addCenter(Vector2f center, float radius, Vector3f color){
